    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden mt-16">
      ...
      <div className="transform translate-y-40">
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-base-content mb-2 sm:mb-4">
            Mary: A Haven of Hope for Families
          </h1>
          <p className="text-lg sm:text-xl md:text-xl lg:text-2xl text-base-content/80 mx-auto">
