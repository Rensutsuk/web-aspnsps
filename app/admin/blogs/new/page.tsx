...
async function createPost(formData: FormData) {
  ...
  if (!title || !author || !content) redirect('/admin/blogs/new')
    ...
    <div className="container mt-12 mx-auto px-4 py-12">
      <div className="flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="opacity-70">Markdown content is stored in the database</p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <form action={createPost} className="lg:col-span-2 space-y-4">
            ...
            <div className="card-body space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="form-control w-full">
                  ...
                  <input name="slug" className="input input-bordered w-full" placeholder="auto-generated from title" />
                </label>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <label className="form-control w-full">
                  ...
                  <input name="author" className="input input-bordered w-full" required />
                </label>
                ...
                <label className="form-control w-full">
                  ...
                  <input name="date" type="date" className="input input-bordered w-full" defaultValue={today} />
                </label>
                ...
                <label className="form-control w-full">
                  ...
                  <input name="published" type="checkbox" className="toggle toggle-primary" defaultChecked />
                </label>
              </div>
              ...
              <label className="form-control w-full">
                ...
                <textarea name="excerpt" className="textarea textarea-bordered w-full" rows={3} />
              </label>
              ...
              <label className="form-control w-full">
                ...
                <textarea name="content" className="textarea textarea-bordered w-full font-mono" rows={18} required />
              </label>
